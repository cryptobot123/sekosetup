...
CONFIGFOLDER='/root/.seko'
COIN_DAEMON='sekod'
COIN_CLI='seko-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Revolutionary1976/sekopay/releases/download/v2.3.0/SekoPay-v2.3.0-DAEMON.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='seko'
COIN_EXPLORER='http://blocks.sekopay.com'
COIN_PORT=4786
RPC_PORT=5786
...
function important_information() {
 ...
 echo -e "${YELLOW}=====================================================================================${NC}"
 echo -e "${RED}Created by MrGrow - Donations are always welcome.${NC}"
 echo -e "${YELLOW}=====================================================================================${NC}"
 echo -e "${GREEN}SEKO: SYuY1KSupmzErcUXdV6DpuBVkFMzeFkuUH${NC}"
 echo -e "${YELLOW}=====================================================================================${NC}"
